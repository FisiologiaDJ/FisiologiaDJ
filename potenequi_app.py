...
if ion == "Ca²⁺":
    ...
    conc_out = st.number_input("Concentración extracelular (mM)", value=130.0, min_value=0.1)
    conc_in = st.number_input("Concentración intracelular (mM)", value=20.0, min_value=0.1)
