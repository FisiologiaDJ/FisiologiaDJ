...
st.info("🩺En Fisiología DJ podrás encontrar una gran cantidad de videos e información que te será de utilidad para todos tus cursos. 🙏 Agradecemos la infinita ayuda de Qwen Studio en el desarrollo e implementación de esta aplicación.")